...
export default function AboutPage() {
  return (
    <main className="min-h-dvh font-sans bg-(--background) text-(--foreground) selection:bg-emerald-100 overflow-hidden">
      
      {/* ⚡ OPTIMIZED HERO BACKGROUND */}
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-size-[32px_32px] pointer-events-none mask-[radial-gradient(ellipse_80%_40%_at_50%_0%,#000_20%,transparent_100%)]" />
      ...
      <Section variant="transparent" padding="none" className="pt-32 md:pt-40 pb-20 relative z-10">
        <div className="max-w-4xl mx-auto text-center px-6">
          <motion.div
             ...
             className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-(--card) border border-(--border) text-(--muted) text-[10px] md:text-xs font-black uppercase tracking-widest mb-8 shadow-sm"
          >
          ...
          <motion.h1
            ...
            className="text-5xl md:text-7xl font-display font-black text-(--foreground) mb-8 tracking-tight leading-[1.05]"
          >
            We didn't just build an app. <br className="hidden md:block"/>
            We fixed <span className="text-transparent bg-clip-text bg-linear-to-r from-emerald-600 to-teal-500">Trust.</span>
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.2 }}
            className="text-lg md:text-xl text-(--muted) leading-relaxed font-light mb-10 max-w-2xl mx-auto"
          >
      ...
      <section className="py-16 md:py-24 px-6 relative z-10">
         <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
            {/* Image Side */}
            <div className="relative h-[400px] md:h-[550px] rounded-4xl md:rounded-[3rem] overflow-hidden group shadow-2xl border-8 border-(--card) transform-gpu hover:scale-[1.02] transition-transform duration-700">
               <Image 
                ...
                />
                <div className="absolute inset-0 bg-linear-to-t from-black/80 via-black/20 to-transparent flex items-end p-6 md:p-8">
                   <div className="flex items-center gap-2 bg-(--card)/20 backdrop-blur-md px-4 py-2 rounded-full text-white font-bold uppercase tracking-widest text-[10px]">
            ...
            <div className="md:pl-8">
               ...
               <h2 className="text-3xl md:text-5xl font-display font-black text-(--foreground) mb-6 tracking-tight">Commerce was broken.</h2>
               <div className="text-base md:text-lg text-(--muted) leading-relaxed font-light space-y-6">
                 <p>
                 ...
                 <p className="font-medium text-(--foreground) border-l-4 border-emerald-500 pl-4 bg-emerald-50/50 dark:bg-emerald-950/30 py-2 pr-2 rounded-r-lg">
      ...
      <section className="px-6 relative z-20 -mb-16 md:-mb-24 mt-12">
        <div className="max-w-5xl mx-auto bg-(--card)/80 backdrop-blur-xl border border-(--border) shadow-2xl shadow-black/10/30 dark:shadow-black/20 rounded-4xl p-8 md:p-12">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-0 md:divide-x divide-(--border) text-center">
                {STATS.map((stat, i) => (
                    <div key={i} className="flex flex-col items-center justify-center px-4">
                        <p className="text-3xl md:text-5xl font-display font-black text-(--foreground) mb-2 tracking-tighter">{stat.value}</p>
                        <p className="text-[10px] md:text-xs font-bold text-(--muted) uppercase tracking-[0.15em]">{stat.label}</p>
                    </div>
                ))}
            </div>
        </div>
      ...
      <section className="bg-slate-950 pt-32 md:pt-48 pb-24 px-6 relative overflow-hidden" aria-labelledby="about-values-heading">
         ...
         <div className="max-w-6xl mx-auto text-center relative z-10">
            <h2 id="about-values-heading" className="text-4xl md:text-6xl font-display font-black mb-16 text-white tracking-tight leading-tight">
               Trust-Powered Commerce <br className="hidden md:block"/> for Africa.
            </h2>
      ...
      <section className="py-24 md:py-32 px-6">
         <div className="max-w-5xl mx-auto">
            <div className="text-center mb-20 md:mb-32">
                ...
                <h2 className="text-4xl md:text-5xl font-display font-black text-(--foreground) tracking-tight">Architecting the future <br className="hidden md:block"/> of African commerce.</h2>
            </div>
            ...
            <div className="space-y-32">
                ...
                <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
                    <div className="w-full lg:w-[45%] relative group">
                        <div className="aspect-4/5 rounded-4xl overflow-hidden bg-(--surface) shadow-2xl relative z-10 border border-(--border)/50">
                            <Image 
                        ...
                        <div className="absolute top-6 -left-6 w-full h-full border-l-2 border-b-2 border-emerald-500/20 rounded-4xl z-0 transition-all duration-500 group-hover:-translate-x-2 group-hover:translate-y-2" />
                    </div>
                    
                    <div className="w-full lg:w-[55%]">
                        <h3 className="text-4xl font-display font-black text-(--foreground) mb-2 tracking-tight">Abdulkareem Abdulkareem</h3>
                        <p className="text-emerald-600 font-bold uppercase tracking-[0.2em] text-xs mb-8">Founder & CTO</p>
                        
                        <div className="text-lg text-(--muted) font-light leading-relaxed space-y-6">
                            <p>
                                Abdulkareem is engineering the <strong>Nervous System</strong> for trust-powered commerce. Sitting at the intersection of high-fidelity product design and sovereign financial infrastructure, he architected StoreLink to solve the critical trust and transaction fragmentation in the African digital marketplace.
                            </p>
                            <p>
                            ...
                            <blockquote className="mt-8 border-l-4 border-(--foreground) pl-6 py-2">
                                <p className="text-xl font-medium text-(--foreground) italic tracking-tight">
                        ...
                        <div className="mt-10">
                            <a href="https://www.linkedin.com/in/abdulkareem-abdulkareem-77747a319" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm font-bold text-(--muted) hover:text-emerald-600 transition-colors uppercase tracking-widest">
                ...
                <div className="flex flex-col lg:flex-row-reverse gap-12 lg:gap-20 items-center">
                    <div className="w-full lg:w-[45%] relative group">
                        ...
                        {/* Elegant Offset Frame */}
                        <div className="absolute top-6 -right-6 w-full h-full border-r-2 border-b-2 border-blue-500/20 rounded-4xl z-0 transition-all duration-500 group-hover:translate-x-2 group-hover:translate-y-2" />
                    </div>
                    
                    <div className="w-full lg:w-[55%]">
                        <h3 className="text-4xl font-display font-black text-(--foreground) mb-2 tracking-tight">Shedrach Maisamari</h3>
                        ...
                        <div className="mt-10">
                            <a href="https://www.linkedin.com/in/shedrach-maisamari-b125b3176/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm font-bold text-(--muted) hover:text-blue-600 transition-colors uppercase tracking-widest">
                                <Linkedin size={16} /> LinkedIn Profile
                            </a>
                        </div>
                    </div>
      ...
      <section className="py-24 bg-(--card) border-y border-(--border) px-6">
         <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
                <h2 className="text-3xl font-display font-black text-(--foreground) tracking-tight">The Squad</h2>
                <p className="text-(--muted) mt-2 font-light">The brilliant minds powering the engine.</p>
            </div>

            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
                {EMPLOYEES.map((member, i) => (
                    <div key={i} className="group text-center bg-(--surface) p-6 rounded-4xl border border-(--border) hover:shadow-xl hover:bg-(--card) transition-all duration-300 transform-gpu hover:-translate-y-1">
                        <div className="relative w-16 h-16 md:w-20 md:h-20 mx-auto rounded-full overflow-hidden mb-4 bg-(--border) ring-4 ring-(--card) shadow-sm">
                        ...
                        <h4 className="font-black text-(--foreground) text-sm mb-1">{member.name}</h4>
                        <p className="text-[9px] text-(--muted) font-bold uppercase tracking-widest">{member.role}</p>
                    </div>
                ))}
            </div>
         </div>
      ...
      <section className="py-24 px-6 bg-(--surface)">
         <div className="max-w-5xl mx-auto text-center bg-slate-900 rounded-[3rem] p-10 md:p-20 relative overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10">
               ...
               <p className="text-lg md:text-xl text-(--muted) leading-relaxed mb-10 max-w-2xl mx-auto font-light">
               ...
               <div className="inline-block bg-(--card)/10 backdrop-blur-md px-6 py-3 rounded-full border border-white/10">
...
function ValueCard({ icon, title, desc }: { icon: React.ReactNode; title: string; desc: string }) {
   return (
      <div className="p-8 md:p-10 rounded-[2.5rem] bg-(--card)/5 border border-white/10 hover:bg-(--card)/10 hover:border-white/20 transition-all duration-300 group">
         <div className="w-12 h-12 rounded-2xl bg-(--card)/10 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
            {icon}
         </div>
