...
import { getTermsContent, VALID_COUNTRY_CODES, COUNTRY_NAMES } from '../../../lib/legalContent';
import Link from 'next/link';

export default function TermsCountryPage() {
  ...
  const content = getTermsContent(countryCode);
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 p-6 rounded-[var(--radius-xl)] bg-[var(--muted)]/10 border border-[var(--border)]">
            <p className="text-sm font-bold text-[var(--muted)] uppercase tracking-wider mb-4">
              View terms for another country
            </p>
  ...
  return (
    <div>
      ...
      <div className="space-y-4">
        ...
        {section.footer && (
          <p className="mt-4 text-red-500 font-bold text-sm uppercase tracking-wide">
            {section.footer}
          </p>
        )}
      </div>
